...
def discretized_mix_logistic_loss(y_hat, y, num_class=256, log_scale_min=-7.0, reduce=True):
    """
    ...
    # log_probs = tf.reduce_sum(log_probs, axis=-1, keep_dims=True) + log_prob_from_logits(logit_probs)
